...
import apiconfig.getserver.ProductionEnv_config as apimgr1
...
class core_server_tests(unittest.TestCase):
    ...
    def test0001_get_server_test(self):
        print "B----------------------------------test0001_get_server_test账号未登录---------------------------------B"
        auth = apimgr.CoreServer_getToken_01
        session = apimgr.CoreServer_getSessionID_01
        info = apimgr1.CoreServer_GetServerTest_01
        self.test.test_get_server_test1(auth, session, info)
        print "E----------------------------------test0001_get_server_test账号未登录-----------------------------------E"
